...
def test_perturb():
    ...
    def setmol(coords,fname='CC.xyz'):
        with open(f'peturbfiles/{fname}', 'w') as xyz:
    ...
    with open('peturbfiles/input.types','w') as typef:
        typef.write(types)
    model = '''layer {{
      name: "data"
      type: "MolGridData"
