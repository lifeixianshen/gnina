...
def test_multipose():
    ...
    with open('multifiles/C.xyz','w') as xyz:
        xyz.write('''1
    
    C          0.00000        0.00000        0.00000
    ''')
    with open('multifiles/N.xyz','w') as xyz:
        xyz.write('''1
    
    N          0.00000        0.00000        0.00000
    ''')
    with open('multifiles/O.xyz','w') as xyz:
        xyz.write('''1
    
    O          0.00000        0.00000        0.00000
    ''')
    with open('multifiles/CC.xyz','w') as xyz:
        xyz.write('''8
